...
/// <summary>
/// A client representation of a Blockmoji item
/// Blockmoji items are non-funglble tokens on a Hyperledger Fabric blockchain network
/// </summary>
public class Item
{
	...
	public static bool ContainsID(string uniqueID)
	{
		return _all.Exists(i => i.UniqueID == uniqueID);
	}
